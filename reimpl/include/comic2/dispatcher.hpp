...
public:
    ...
    void set_airborne_physics_hook(StageHook hook) { airborne_physics_hook_ = std::move(hook); }
    void set_timed_overlay_hook(StageHook hook) { timed_overlay_hook_ = std::move(hook); }
    void set_grounded_physics_hook(StageHook hook) { grounded_physics_hook_ = std::move(hook); }
    void set_player_animation_hook(StageHook hook) { player_animation_hook_ = std::move(hook); }
    void set_attack_animation_hook(StageHook hook) { attack_animation_hook_ = std::move(hook); }
    void set_distance_interaction_hook(StageHook hook) { distance_interaction_hook_ = std::move(hook); }
    void set_tile_hazard_hook(StageHook hook) { tile_hazard_hook_ = std::move(hook); }
    void set_player_special_state_hook(StageHook hook) { player_special_state_hook_ = std::move(hook); }
    void set_input_handling_hook(StageHook hook) { input_handling_hook_ = std::move(hook); }
